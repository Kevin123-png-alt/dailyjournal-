    ...
    <button type="button" class="btn btn-secondary mb-2" data-bs-toggle="modal" data-bs-target="#modalTambah">
        ...
        <div class="row">
            <div class="table-responsive" id="galery_data">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nama" placeholder="Tuliskan Nama Foto" required>
                        </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        if (isset($_POST['id'])) {
            ...
            $stmt = $conn->prepare("INSERT INTO galery (nama,gambar,tanggal,username)
                                    VALUES (?,?,?,?)");
